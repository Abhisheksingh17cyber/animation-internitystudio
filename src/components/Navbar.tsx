...
export default function Navbar() {
  ...
  // (useEffect for closing menu removed to prevent setState cascading render warnings. Menu can be closed manually or you can add onClick to links)
  ...
  return (
    <nav className={`navbar${scrolled ? " navbar--scrolled" : ""}`}>
      ...
      <div className={`menu ${mobileMenuOpen ? 'menu--open' : ''}`}>
        ...
        <Link href="/products" className={`link${pathname === "/products" ? " active" : ""}`}>
          <span className="link-icon">
        ...
        <Link href="/process" className={`link${pathname === "/process" ? " active" : ""}`}>
          <span className="link-icon">
          ...
          <span className="link-title">Process</span>
        </Link>
      ...
      {/* Pill CTA */}
      <Link href="/contact" className="navbar-cta-pill desktop-only">
        Get Started
      </Link>
    </nav>
  );
